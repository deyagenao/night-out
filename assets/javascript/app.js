...
$("#search-events").on("click", function(event){
    ...
    var eventQueryURL = "https://app.ticketmaster.com/discovery/v2/events?apikey=7elxdku9GGG5k8j0Xm8KWdANDgecHMV0&locale=*&startDateTime="+convertedStartDate+"Z&endDateTime="+convertedEndDate+"Z&city=New%20York&sort=date,asc&keyword="+searchEventKeyword;
    $.ajax({
        url: eventQueryURL,
        method: "GET"
...
$(document).on("click", ".show-weather", function(){
  ...
  var weatherQueryURL = "https://api.weatherbit.io/v2.0/forecast/daily?city=New+York,NY&key=a31365dc0d9a40f2944f326c68467d40&units=I";
